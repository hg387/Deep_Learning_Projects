...
processValuesY{(numberOfThetas+1),1} = zeros(testingSize,14); % other than last layers randomized b/w 0 to 1.
...
iterations = [];
iteration = 0;
alpha = 0.00001;%L2 regularization
